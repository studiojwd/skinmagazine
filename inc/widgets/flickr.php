...
?>
    <div class="row albwidget">
        <div class="flickr">
            <div class="flickrdom" data-id="<?php echo esc_attr( $userid ); ?>" data-itemfetch="<?php echo esc_attr( $fetch ); ?>"></div>
        </div>
    </div>
...
/*oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo*/
    ...
    function form( $instance ) {
        ...
        <p>
			...
			Items to Fetch
			<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id('fetch') ); ?>" name="<?php echo esc_attr( $this->get_field_name('fetch') ); ?>" value="<?php echo esc_attr($fetch); ?>" />
			</label>
		</p>
